...
export RUN_ROOT="$REPO/logs_fp16_flash/vbench_mtd1_fp32t5_fp16flash_ddim100_cfg4_seed42_gpu0_0802"
export LOCK_FILE="$REPO/logs_fp16_flash/.vbench_mtd1_fp32t5_gpu0.lock"
export EXPERIMENT_NAME="FP16_FlashAttention_W4A6_MTD1_with_FP32_T5_embeddings"
